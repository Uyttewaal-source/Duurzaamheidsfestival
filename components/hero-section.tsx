...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-green-soft px-4 py-20 lg:px-6 lg:py-32">
      {/* Decorative butterfly — langzaam zweven */}
      <div className="butterfly-float absolute right-0 top-1/2 -translate-y-1/2 opacity-5 lg:opacity-10">
        <Image
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        {/* Logo */}
        <div className="hero-fade-down mb-8 flex justify-center">
          <Image
        ...
        {/* Main title */}
        <h1
          className="hero-fade-up mb-6 text-4xl font-bold leading-tight text-green-primary md:text-5xl lg:text-6xl"
        ...
        {/* Key info grid */}
        <div
          className="hero-fade-up mb-10 grid gap-4 sm:grid-cols-3"
        ...
        {/* Target audience */}
        <p
          className="hero-fade-up mb-10 text-dark-text/70"
          style={{ animationDelay: "0.45s" }}
        >
          Voor docenten, bestuurders, onderwijsprofessionals en Eco-teams
        </p>
        ...
        >
          <Button
            asChild
            size="lg"
            className="rounded-full bg-red-primary px-8 text-white transition-transform duration-200 hover:scale-105 hover:bg-red-primary/90"
          >
          ...
          <Button
            ...
            variant="outline"
            size="lg"
            className="rounded-full border-2 border-green-primary bg-white px-8 text-green-primary transition-transform duration-200 hover:scale-105 hover:bg-green-soft"
          >
